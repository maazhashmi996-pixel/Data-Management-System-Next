                ...
                <form onSubmit={handleSetup} className="p-8 space-y-5">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input required placeholder="Super Admin" className="w-full border border-gray-200 pl-10 p-3 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-black font-semibold"
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input required type="email" placeholder="admin@system.com" className="w-full border border-gray-200 pl-10 p-3 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-black font-semibold"
                    ...
                    <button disabled={loading} className="w-full bg-blue-600 text-white py-4 rounded-xl font-bold hover:bg-blue-700 transition-all flex items-center justify-center gap-2 group disabled:opacity-70">
